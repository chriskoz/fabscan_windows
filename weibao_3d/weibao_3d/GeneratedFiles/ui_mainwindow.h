...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        spinBox_x->setMaximum(1280);
        spinBox_x->setValue(300);

        horizontalLayout->addWidget(spinBox_x);

        toggleViewButton = new QPushButton(centralWidget);
        toggleViewButton->setObjectName(QStringLiteral("toggleViewButton"));
        toggleViewButton->setMinimumSize(QSize(175, 0));
        toggleViewButton->setMaximumSize(QSize(175, 16777215));
        toggleViewButton->setFocusPolicy(Qt::NoFocus);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label_2->setText(QApplication::translate("MainWindow", "XY", 0));
        toggleViewButton->setText(QApplication::translate("MainWindow", "Compute Surface Mesh", 0));
