...
public:
    ...
    void setupUi(QWidget *FSControlPanel)
    {
        ...
        groupBox->setGeometry(QRect(10, 120, 121, 190));
        ...
        laserStepLeftButton->setGeometry(QRect(10, 80, 51, 32));
        ...
        groupBox_3->setGeometry(QRect(10, 0, 121, 111));
        ...
        checkBox->setGeometry(QRect(20, 80, 70, 20));
